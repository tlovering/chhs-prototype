    ...
    <section class="secondary-nav container-fluid">
      <div class="row">
        ...
        <div class="info-col col-login-info col-md-5">
          <div>
            <p><a href="/">Create an account</a> to find and
              communicate with foster homes in your area.</p>
          </div>
        </div>
        ...
        <div class="info-col col-account-info col-md-5">
          <div>
            <p><a href="/">Sign in</a> to find and communicate with
              foster homes in your area.</p>
          </div>
        </div>
      </div>
    </section>
...
<sec:authorize access="isAnonymous()">
  ...
  <form>
    ...
    <input ng-model="home.auth.password" type="password"
